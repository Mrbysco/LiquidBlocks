...
public class ShapelessRecipeNoRemainderBuilder implements RecipeBuilder {
	...
	public ShapelessRecipeNoRemainderBuilder unlockedBy(String p_126197_, CriterionTriggerInstance p_126198_) {
		this.advancement.addCriterion(p_126197_, p_126198_);
		return this;
	}

	public ShapelessRecipeNoRemainderBuilder group(@Nullable String p_126195_) {
	...
	public void save(Consumer<FinishedRecipe> p_126205_, ResourceLocation p_126206_) {
		...
		p_126205_.accept(new ShapelessRecipeNoRemainderBuilder.Result(p_126206_, this.result, this.count, this.group == null ? "" : this.group, this.ingredients, this.advancement, new ResourceLocation(p_126206_.getNamespace(), "recipes/" + this.result.getItemCategory().getRecipeFolderName() + "/" + p_126206_.getPath())));
	}
