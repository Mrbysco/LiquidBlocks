...
public class ShapelessRecipeNoRemainderBuilder implements RecipeBuilder {
	...
	public void save(Consumer<FinishedRecipe> p_126205_, ResourceLocation p_126206_) {
		...
		p_126205_.accept(new Result(p_126206_, this.result, this.count, this.group == null ? "" : this.group, this.ingredients, this.advancement, new ResourceLocation(p_126206_.getNamespace(), "recipes/" + this.result.getItemCategory().getRecipeFolderName() + "/" + p_126206_.getPath())));
	}
